...
EXCLUDE_EX = {
    ...
    'リバースプッシュアップ\n＋\nダンベルカール','ダンベルカール\nアームカール-EZバー',
    'シーテッドロー-チューブ','トライセプスキックバック',
    'リバースプッシュアップ','サイドライイングプルオーバー','腕立て伏せ',
}
...
SHOULDER_EX = {'サイドレイズ','ショルダープレス','フロントレイズ','リアレイズ'}
ARM_EX      = {'アームカール-ダンベル','アームカール-EZバー','フレンチプレス','リストカール'}
LEG_EX      = {'ブルガリアンスクワット','バックランジ','スクワット',
